...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: `
      • Developed an e-commerce website clone of Myntra using HTML, CSS, and JavaScript, achieving a 95% feature parity.
      • Implemented user authentication, product listing, shopping cart, and checkout process functionalities.
      • Engineered a responsive UI ensuring optimal performance across devices, resulting in a 30% increase in user engagement.
      • Gained proficiency in HTML, CSS, and JavaScript frameworks through hands-on development.
    `,
  },
  {
...
export const ACHEVIEMENTS = [
  ...
  " Reached till last round of Walmart CODEHERS 2024",
];
